...
AiResult AiService::draft_atam(const AiDraftAtamRequest& req) {
    ...
    p << "Draft initial ATAM work products from the architect notes.\n\n"
      ...
      << "Start with '{' and end with '}'. Do not include Markdown, comments, analysis, "
      << "self-corrections, explanations, or text before/after the JSON.\n\n"
      << "Top-level JSON fields: systemContext string; businessDrivers array of strings; "
      << "constraints array of strings; assumptions array of strings; approaches array; "
      << "scenarios array; findings array.\n"
      << "Each approach object fields: name, description, qualityAttributes array, tactics array.\n"
      << "Each scenario object fields: qualityAttribute, stimulusSource, stimulus, environment, "
      << "artifact, response, responseMeasure, importance, difficulty. Use H/M/L for importance and difficulty.\n"
      << "Each finding object fields: kind, description, severity. "
      << "kind must be one of risk, non-risk, sensitivity-point, tradeoff-point. "
      << "Use H/M/L for severity.\n\n"
